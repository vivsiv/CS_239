...
text(plt1, fastest_exe_time$Avg_Execution_Time, labels = round(fastest_exe_time$Avg_Execution_Time,2), pos = 3, cex=0.75)
...
text(plt2, slowest_exe_time$Avg_Execution_Time, labels = round(slowest_exe_time$Avg_Execution_Time,2), pos = 3, cex=0.75)
...
text(plt3, most_num_calls$Num_Calls, labels = round(most_num_calls$Num_Calls,2), pos = 3, cex=0.75)
...
text(plt4, most_call_stack$Num_Calls, labels = round(most_call_stack$Num_Calls,2), pos = 3, cex=0.75)