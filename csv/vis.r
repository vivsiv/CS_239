...
plt1 <- barplot(fastest_exe_time$Avg_Execution_Time,main="Top 10 Fastest Methods",xlab="Function Name",names.arg=fastest_exe_time$Function_Name,ylab="Avg Ex Time (usec)",cex.names=0.75,las=2)
...
plt2 <- barplot(slowest_exe_time$Avg_Execution_Time,main="Top 10 Slowest Methods",xlab="Function Name",names.arg=slowest_exe_time$Function_Name,ylab="Avg Ex Time (usec)",cex.names=0.75,las=2)
...
plt3 <- barplot(most_num_calls$Num_Calls,main="Top 10 Frequent Methods",xlab="Function Name",names.arg=most_num_calls$Function_Name,ylab="Number of Calls",cex.names=0.75,las=2)
...
plt4 <- barplot(most_call_stack$Num_Calls,main="Top 10 Frequent Call Stacks",xlab="Stack Name Name",names.arg=most_call_stack$Function_Name,ylab="Number of Calls",cex.names=0.75,las=2)
